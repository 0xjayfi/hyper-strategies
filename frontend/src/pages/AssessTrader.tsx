...
export function AssessTrader() {
  ...
  return (
    <PageLayout
      title="Assess Trader"
      description="Evaluate any Hyperliquid trader address across 10 independent scoring strategies. Get a quality verdict with a confidence tier based on how many strategies the address passes. Results are cached for 10 minutes."
    >
