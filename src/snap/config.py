...
ML_BACKFILL_STRIDE_DAYS: int = int(os.environ.get("SNAP_ML_STRIDE_DAYS", "7"))
ML_PROFIT_FACTOR_CAP = float(os.getenv("SNAP_ML_PF_CAP", "20.0"))
ML_EARLY_STOPPING_ROUNDS = int(os.getenv("SNAP_ML_EARLY_STOP", "50"))
